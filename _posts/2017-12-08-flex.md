...
例如上面： main为800px 三个DIV分别是150px,200px,250px 放大倍数分别是0.2，0.1，0.3，因为他们相加不等于1，那么我们不管如何都是除以1。所以如下方的计算方法：

800-(150+200+250) = 200   // 剩余容器宽度

200px*0.2/1 = 40     // 放大0.2倍之后子项目增加的像素

200px*0.1/1 = 20     // 放大0.1倍之后子项目增加的像素

200px*0.3/1 = 60     // 放大0.3倍之后子项目增加的像素
